...
% legend('CLGLRT,\sigma^2=0.1','GLRTCC,\sigma^2=0.1','GLRTML,\sigma^2=0.1',...
%        'CLGLRT,\sigma^2=0.2','GLRTCC,\sigma^2=0.2','GLRTML,\sigma^2=0.2',...
%        'CLGLRT,\sigma^2=0.3','GLRTCC,\sigma^2=0.3','GLRTML,\sigma^2=0.3',...
%        'CLGLRT,\sigma^2=0.4','GLRTCC,\sigma^2=0.4','GLRTML,\sigma^2=0.4',...
%        'CLGLRT,\sigma^2=0.5','GLRTCC,\sigma^2=0.5','GLRTML,\sigma^2=0.5',...
%        'KGLRT')
xlabel('SNR/dB','FontSize',20)
ylabel('Pd','FontSize',20)
set(gca,'FontSize',20)
