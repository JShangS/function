...
plot(SNRout(1:26),Pd_CLGLRT_mc(1:26),'k-p','linewidth',linewide1,'markersize',mkft);
plot(SNRout(1:26),Pd_KGLRTCC_mc(1:26),'g-p','linewidth',linewide1,'markersize',mkft);
plot(SNRout(1:26),Pd_KGLRT_mc(1:26),'b-p','linewidth',linewide1,'markersize',mkft);
plot(SNRout(1:26),Pd_KGLRTNSCM_mc(1:26),'c-p','linewidth',linewide1,'markersize',mkft);
