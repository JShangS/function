...
plot(SNRout,Pd_CLGLRT_mc,'k-h','linewidth',2,'markersize',10);
plot(SNRout,Pd_KGLRTCC_mc,'g-h','linewidth',2,'markersize',10);
plot(SNRout,Pd_KGLRT_mc,'b-h','linewidth',2,'markersize',10);
plot(SNRout,Pd_KGLRTNSCM_mc,'c-h','linewidth',2,'markersize',10);
h_leg = legend...
       ('\lambda=1,GLC-GLRT',        '\lambda=1,1S-GLRT with CC ',...
       '\lambda=1,1S-GLRT with SCM ','\lambda=1,1S-GLRT with NSCM ',...
       '\lambda=2,GLC-GLRT',        '\lambda=2,1S-GLRT with CC ',...
       '\lambda=2,1S-GLRT with SCM ','\lambda=2,1S-GLRT with NSCM ',...
