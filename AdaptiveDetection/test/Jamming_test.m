...
parfor i=1:MonteCarloPfa
    ...
    R_n = fun_SCMN(Train);
    x = fun_TrainData('g',N,1,R,3);
    Tace(i) = fun_ANMF(R_n,x,vt);
    R_z = R_n + R_j;
...
for m=1:length(SNRout)
    ...
    parfor i=1:MonteCarloPd
        ...
        Tace_orig = fun_ANMF(R_n,x,vt); %%原始的ACE
...
plot(SNRout,Pd_OPT_mc,'y');
legend('门限确定不含干扰','门限确定含有干扰','基本的ACE','最优')
